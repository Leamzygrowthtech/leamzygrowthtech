...
const Services = () => {
  ...
  const services = [{
    ...
    features: ['Real-time reputation monitoring', 'Crisis management strategies', 'Brand protection protocols', 'Negative review mitigation', 'Online mention tracking', 'Reputation recovery campaigns'],
    popular: false
  }, {
    ...
    features: ['Google Ads campaign setup', 'Facebook & Instagram advertising', 'Targeted audience research', 'Ad copy and creative development', 'Campaign optimization', 'ROI tracking and reporting'],
    popular: false
  }, {
    ...
    features: ['Brand identity development', 'Strategic market positioning', 'Logo and visual identity', 'Brand messaging optimization', 'Target audience research', 'Strategic consulting sessions'],
    popular: false
  }, {
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 via-white to-green-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl font-bold mb-6">
            <span className="bg-gradient-to-r from-blue-600 to-green-600 bg-clip-text text-transparent">FULL MARKETING</span>
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => <Card key={index} className={`relative hover:shadow-2xl transition-all duration-300 border-0 shadow-lg ${service.popular ? 'ring-2 ring-blue-500' : ''}`}>
